...
# So you went in to your code and added order.compute_tax to the pay_by_cash 
# method.
# Everything was great, until you realized you forgot to add it to pay_by_check 
# also!
#
# You fixed this bug already, but the same code is duplicated in many places,
# so the bug fix didn't get everything. Frustrated, you decide to refactor 
# your code.
# 
...
#
# **Create the pay_by method, and refactor each of the four methods below such 
# that they
# invoke the pay_by method, and pass it the order, to take care of the code that 
# is all the same
# Let them pass a block to take care of the code that is unique.**
#
# NOTE: This code will only work with the rake tests, which will define the 
# order and current_user
